          ...
          <tr>
            ...
            <td>
              <div class="d-inline-flex">
                <v-btn small icon flat class="mx-0" color="grey" :to="`companies/${props.item.id}`" >
            ...
            <td>
              <div class="img-container">
                <img class="logo-img" :src="props.item.logo_url">
              </div>
            </td>
...
<script>
  ...
  import AddItemDialog from '../../components/companies/AddItemDialog'
  import EditItemDialog from '../../components/companies/EditItemDialog'
  import DeleteItemDialog from '../../components/companies/DeleteItemDialog'
